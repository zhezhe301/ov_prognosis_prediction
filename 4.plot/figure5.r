...
setwd('~/Project/ov_prognosis_drugprecision/plot/venn/')
library('VennDiagram')
library('grid')
...
col.k562 <- '#fb9a99'
setEPS()
png('survival.venn.png',width=6,height=6,fonts=c("serif", "Palatino"),units="in",res=300)
...
col.k562 <- '#fb9a99'
setEPS()
png('treatment.venn.png',width=6,height=6,fonts=c("serif", "Palatino"),units="in",res=300)
draw.triple.venn(n1, n2, n3, n12,n23, n13,  n123, category=c('DNA-seq','RNA-seq','DNA-methy'),col=c(col.helas3,col.huvec,col.k562),fill=c(col.helas3,col.huvec,col.k562),cat.dist=c(1,1,1)*0.26, lwd=5,cex=1.5,cat.cex=1.5,margin=0.1)
dev.off()
...
setwd('~/Project/ov_prognosis_drugprecision/plot/venn/venn.circos/')
library('VennDiagram')
library('grid')
library('futile.logger')
n1 <- 15
