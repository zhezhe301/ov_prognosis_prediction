...
setEPS()
png('figure3A.png',width=10,height=6,fonts=c("serif", "Palatino"),units="in",res=300)
...
try$omic <- factor(try$omic,levels=c('DNA-seq','RNA-seq','miRNA-seq','DNA-methy'))
setEPS()
png('figure3B.png',width=10,height=6,fonts=c("serif", "Palatino"),units="in",res=300)
...
try$omic <- factor(try$omic,levels=c('DNA-seq','RNA-seq','miRNA-seq','DNA-methy'))
setEPS()
png('figure3C.png',width=15,height=6,fonts=c("serif", "Palatino"),units="in",res=300)
