...
for (k in 1:nrFolds) {
  ...
  setwd('~/Project/ov_prognosis_drugprecision/result/4.prediction/2.RNAseq/')
...
for (k in 1:100) {
  setwd('~/Project/ov_prognosis_drugprecision/result/4.prediction/2.RNAseq/dt_classifier/')
  ...
  setwd('~/Project/ov_prognosis_drugprecision/result/4.prediction/2.RNAseq/rf_classifier/')
  ...
  setwd('~/Project/ov_prognosis_drugprecision/result/4.prediction/2.RNAseq/dnn_classifier/')
