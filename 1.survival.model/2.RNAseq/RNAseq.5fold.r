...
table3[,c('CSN1S1','KRTAP9.9','KRTAP10.8','OR9G9','KRTAP13.1','RBMXL3','C10orf113')] <- NULL # outlier
# ,'KRTAP5.3',MAGEB4,GPR112,OR11H6,KRTAP2.2,OR10H5,MCART3P,APOL5
...
for (i in 1:20) {
  ...
  for (k in 1:nrFolds) {
    ...
    coxph.model <- coxph(Surv(data.test$days,data.test$vital_status) ~selectedtestX,init=scale(selectedBeta),iter=0)
